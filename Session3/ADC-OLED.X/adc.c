...
void adc_init() {
    ...
    //ADC0.CTRLC |= (VREF_REFSEL_VDD_gc);
    VREF.ADC0REF = VREF_REFSEL_VDD_gc; // I think this is more correct
    ...
    // Disable digital input buffer, not nescessary but gives cleaner reading
