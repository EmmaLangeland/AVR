...
# Handle files with suffix elf, for group default-XC8
if(Session2_Timer_default_default_XC8_FILE_TYPE_objcopy_lss)
add_library(Session2_Timer_default_default_XC8_objcopy_lss OBJECT ${Session2_Timer_default_default_XC8_FILE_TYPE_objcopy_lss})
    Session2_Timer_default_default_XC8_objcopy_lss_rule(Session2_Timer_default_default_XC8_objcopy_lss)
    list(APPEND Session2_Timer_default_library_list "$<TARGET_OBJECTS:Session2_Timer_default_default_XC8_objcopy_lss>")

endif()


# Main target for this project
add_executable(Session2_Timer_default_image_YxHBNC9X ${Session2_Timer_default_library_list})

set_target_properties(Session2_Timer_default_image_YxHBNC9X PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${Session2_Timer_default_output_dir}")
target_link_libraries(Session2_Timer_default_image_YxHBNC9X PRIVATE ${Session2_Timer_default_default_XC8_FILE_TYPE_link})
# Add the link options from the rule file.
Session2_Timer_default_link_rule( Session2_Timer_default_image_YxHBNC9X)


#Add objcopy steps
Session2_Timer_default_objcopy_avr_rule(Session2_Timer_default_image_YxHBNC9X)
Session2_Timer_default_objcopy_lss_rule(Session2_Timer_default_image_YxHBNC9X)
