...
set(PACK_REPO_PATH "C:/Users/elang/.mchp_packs" CACHE PATH "Path to the root of a pack repository.")
...
function(Session2_Timer_default_objcopy_lss_rule target)
    add_custom_command(
        TARGET ${target}
        POST_BUILD
        COMMAND ${OBJDUMP}
        ARGS --disassemble --wide --demangle --line-numbers --section-headers --source ${Session2_Timer_default_image_name} > ${Session2_Timer_default_image_base_name}.lss
        WORKING_DIRECTORY ${Session2_Timer_default_output_dir})
endfunction()
