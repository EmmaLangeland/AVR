...
#define TX_PIN            0
#define KLAKK_ADC_CHANNEL 0x0 // fix this
...
void usart_init(unsigned long baud) {
    ...
    // Chapter 27.3 in datasheet tells us how this is done:
    // You can see on the pinout for the Curiosity Nano that USART3 connects to
    // the usb.
