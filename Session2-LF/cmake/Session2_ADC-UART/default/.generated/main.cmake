...
if(Session2_ADC_UART_default_default_XC8_FILE_TYPE_objcopy_avr)
add_library(Session2_ADC_UART_default_default_XC8_objcopy_avr OBJECT ${Session2_ADC_UART_default_default_XC8_FILE_TYPE_objcopy_avr})
    Session2_ADC_UART_default_default_XC8_objcopy_avr_rule(Session2_ADC_UART_default_default_XC8_objcopy_avr)
    list(APPEND Session2_ADC_UART_default_library_list "$<TARGET_OBJECTS:Session2_ADC_UART_default_default_XC8_objcopy_avr>")

endif()


# Main target for this project
add_executable(Session2_ADC_UART_default_image_74P2JQSR ${Session2_ADC_UART_default_library_list})

set_target_properties(Session2_ADC_UART_default_image_74P2JQSR PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${Session2_ADC_UART_default_output_dir}")
target_link_libraries(Session2_ADC_UART_default_image_74P2JQSR PRIVATE ${Session2_ADC_UART_default_default_XC8_FILE_TYPE_link})
# Add the link options from the rule file.
Session2_ADC_UART_default_link_rule( Session2_ADC_UART_default_image_74P2JQSR)


#Add objcopy steps
Session2_ADC_UART_default_objcopy_avr_rule(Session2_ADC_UART_default_image_74P2JQSR)
