...
set(Session2_PWM_default_library_list )

# Handle files with suffix (s|as|asm|AS|ASM|As|aS|Asm), for group default-XC8
if(Session2_PWM_default_default_XC8_FILE_TYPE_assemble)
...
if(Session2_PWM_default_default_XC8_FILE_TYPE_assemblePreprocess)
...
if(Session2_PWM_default_default_XC8_FILE_TYPE_compile)
...
add_executable(Session2_PWM_default_image_oRVX4ET9 ${Session2_PWM_default_library_list})

set_target_properties(Session2_PWM_default_image_oRVX4ET9 PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${Session2_PWM_default_output_dir}")
target_link_libraries(Session2_PWM_default_image_oRVX4ET9 PRIVATE ${Session2_PWM_default_default_XC8_FILE_TYPE_link})
# Add the link options from the rule file.
Session2_PWM_default_link_rule( Session2_PWM_default_image_oRVX4ET9)
